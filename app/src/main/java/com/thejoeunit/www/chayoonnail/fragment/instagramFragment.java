...
public class InstagramFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.instaLinkImg = (ImageView) v.findViewById(R.id.instaLinkImg);
        this.instaLogoImg = (ImageView) v.findViewById(R.id.instaLogoImg);

        instaLinkImg.setOnClickListener(new View.OnClickListener() {
            @Override
